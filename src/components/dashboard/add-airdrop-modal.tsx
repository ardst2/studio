...
// ScrollArea tidak lagi digunakan di sini
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-2xl p-0 max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <DialogHeader className="p-6 pb-4 border-b border-border shrink-0 bg-card z-10">
        ...
        <div className="flex-grow overflow-y-auto min-h-0">
          {/* Wrapper untuk padding form dan loader */}
