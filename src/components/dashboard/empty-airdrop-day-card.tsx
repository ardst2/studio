    ...
    <Card className="shadow-xl h-full bg-card text-card-foreground p-6">
      <CardContent className="flex flex-col items-center justify-center text-center h-full space-y-4">
        <div className="relative">
          ...
          <Button variant="ghost" size="icon" className="absolute -top-2 -right-2 bg-muted/50 hover:bg-muted rounded-full h-8 w-8">
        ...
        {/* The button to add is now part of the "Kelola Airdrop Anda" card generally
            This card serves more as a display. If specific action needed from here,
            it could be added back. For now, matching the image's text.
        */}
      </CardContent>
    </Card>
  );
