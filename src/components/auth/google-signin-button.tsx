...
const GoogleLogoIcon = () => (
  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> {/* Logo sedikit diperbesar */}
...
const GoogleSignInButton = () => {
  ...
  return (
    <Button 
      ...
      disabled={loading} 
      variant="default" // Mengubah ke variant default untuk background solid
      className={cn(
        "h-16 w-auto px-8 py-4 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 ease-in-out", // Bentuk lebih persegi panjang, ukuran lebih besar
        "bg-card hover:bg-muted/80 border border-border/50", // Background card, hover lebih lembut
        "text-foreground font-medium text-lg flex items-center gap-3", // Teks lebih besar dan ada gap
